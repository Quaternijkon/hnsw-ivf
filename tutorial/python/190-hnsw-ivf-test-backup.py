...
if ENABLE_DETAILED_MEMORY_MONITORING:
    ...
    print(f"  索引内存: {final_info['index_memory_mb']:.2f} MB ({final_info['index_memory_mb']/final_info['rss_mb']*100:.1f}%)")
    print(f"  其他内存: {final_info['other_memory_mb']:.2f} MB ({final_info['other_memory_mb']/final_info['rss_mb']*100:.1f}%)")
