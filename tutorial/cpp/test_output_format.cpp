...
int main() {
    ...
    vector<TestResult> results = {
        {1, 8.5, 1177.46, 121.26, 831.48, 198.37, 874.66, 9.71, 0.8487, 0.8, 1.2, 540.97},
        {10, 1.3, 7922.13, 154.45, 160.61, 34.36, 24.61, 51.29, 1.1392, 1.1, 1.5, 540.97},
        {20, 1.1, 8730.37, 174.98, 168.46, 31.97, 22.96, 49.89, 2.0735, 2.0, 3.0, 540.97},
        {40, 1.2, 8518.31, 194.24, 194.80, 33.37, 26.82, 43.85, 3.5807, 3.5, 4.5, 540.97}
    };
    ...
    // 输出表头到文件
    output_file << "Threads,Time(s),QPS,Avg Power(W),CPU Energy(J),Mem Energy(J),Power/Query(mJ),Efficiency,Avg Lat(ms),P50 Lat(ms),P99 Lat(ms),Peak Mem(MB)" << endl;
